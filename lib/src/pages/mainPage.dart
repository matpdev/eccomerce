...
import 'package:eccomerce/src/pages/home_page.dart';
import 'package:eccomerce/src/pages/shopping_cart_page.dart';
import 'package:eccomerce/src/themes/light_color.dart';
import 'package:eccomerce/src/themes/theme.dart';
import 'package:eccomerce/src/widgets/BottomNavigationBar/bottom_navigation_bar.dart';
      ...
      child: Row(
        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              TitleText(
                text: isHomePageSelected ? "Nossos" : "Compra",
                fontSize: 27,
                fontWeight: FontWeight.w400,
              ),
              TitleText(
                text: isHomePageSelected ? "Produtos" : "Carrinho",
                fontSize: 27,
        ...
        child: Stack(
          ...
          children: <Widget>[
            ...
            Positioned(
                bottom: 0,
                right: 0,
                child: CustomBottomNavigattionBar(
