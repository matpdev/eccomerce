...
class AppTheme {
  ...
  static ThemeData lightTheme = ThemeData(
      ...
      iconTheme: const IconThemeData(color: LightColor.iconColors),
      bottomAppBarColor: LightColor.lightGrey,
  ...
  static TextStyle h4Style = const TextStyle(fontSize: 2);
  static TextStyle h5Style = const TextStyle(fontSize: 22);
  static TextStyle h6Style = const TextStyle(fontSize: 22);
