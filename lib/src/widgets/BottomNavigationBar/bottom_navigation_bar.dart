import 'package:eccomerce/src/widgets/BottomNavigationBar/bottom_curved_painter.dart';
import 'package:flutter/material.dart';
import 'package:eccomerce/src/themes/light_color.dart';

class CustomBottomNavigattionBar extends StatefulWidget {
  final Function(int)? onIconPresedCallback;
  const CustomBottomNavigattionBar({Key? key, this.onIconPresedCallback})
      : super(key: key);

  @override
  State<CustomBottomNavigattionBar> createState() =>
      _CustomBottomNavigattionBarState();
}

class _CustomBottomNavigattionBarState extends State<CustomBottomNavigattionBar>
